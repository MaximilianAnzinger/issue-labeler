...
describe('containsKeyword', () => {
  ...
  it('should correctly match single word - case sensitive', () => {
    ...
    expect(containsKeyword('some content', 'content', true)).toBeTruthy();
  ...
  it('should match multiple words - case sensitive', () => {
    expect(
      containsKeyword('some content and some more content', 'content', true)
    ).toBeTruthy();
    expect(
      containsKeyword('some Content and some more content', 'content', true)
    ).toBeTruthy();
  ...
  it('should correctly match regex - case sensitive', () => {
    expect(containsKeyword('content', '(content|some)', true)).toBeTruthy();
    expect(containsKeyword('Order number: 12345', '\\d+', true)).toBeTruthy();
    expect(containsKeyword('Order number: ABCDE', '\\d+', true)).toBeFalsy();
    expect(
    ...
    expect(containsKeyword('This costs $100', '\\$100', true)).toBeTruthy();
    expect(containsKeyword('Do you use C++?', 'C\\+\\+', true)).toBeTruthy();
  });

  it('should correctly match single word - case insensitive', () => {
    expect(containsKeyword('content', 'Content', false)).toBeTruthy();
    expect(containsKeyword('content', 'CONTENT', false)).toBeTruthy();
    expect(containsKeyword('some content', 'conTent', false)).toBeTruthy();
  ...
  it('should match multiple words - case insensitive', () => {
    expect(
      containsKeyword('some content and some more content', 'content', false)
    ).toBeTruthy();
    expect(
      containsKeyword('some Content and some more content', 'content', false)
    ).toBeTruthy();
  ...
  it('should correctly match regex - incase sensitive', () => {
    expect(containsKeyword('content', '(Content|sOme)', false)).toBeTruthy();
    expect(containsKeyword('Order number: 12345', '\\d+', false)).toBeTruthy();
    expect(containsKeyword('Order number: ABCDE', '\\d+', false)).toBeFalsy();
    expect(
    ...
    expect(containsKeyword('This costs $100', '\\$100', false)).toBeTruthy();
    expect(containsKeyword('Do you use C++?', 'c\\+\\+', false)).toBeTruthy();
  });
});
